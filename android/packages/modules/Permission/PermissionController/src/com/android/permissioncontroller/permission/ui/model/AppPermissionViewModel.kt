...
import com.android.permissioncontroller.permission.ui.model.AppPermissionViewModel.ButtonType.CUSTOM_LOCATION
...
import com.android.permissioncontroller.permission.utils.KotlinUtils.isCustomLocationEnabled
    ...
    val buttonStateLiveData =
        object : SmartUpdateMediatorLiveData<@JvmSuppressWildcards Map<ButtonType, ButtonState>>() {
            ...
            override fun onUpdate() {
                ...
                if (shouldShowCustomLocation == null) {
                ...
                value =
                    mapOf(
                        ...
                        CUSTOM_LOCATION to customLocationState
                    )
            }
        }
